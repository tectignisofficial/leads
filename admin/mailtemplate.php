    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active nav-item"><a class="d-flex align-items-center" href="modal-examples.html"><i data-feather="square"></i><span class="menu-title text-truncate" data-i18n="Modal Examples">Modal Examples</span></a>
                </li>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <!-- modal trigger button -->
                                    <a href="mail-reset-password.php" target="_blank">
                                    <button type="button" class="btn btn-primary">
                                        Show
                                    </button></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="card-title">Verify Mail</h5>
                                 
                                    <!-- modal trigger button -->
                                    <a href="mail-verify-email.php" target="_blank">
                                    <button type="button" class="btn btn-primary" >
                                        Show
                                    </button></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <!-- modal trigger button -->
                                    <a href="mail-deactivate-account.php" target="_blank">
                                    <button type="button" class="btn btn-primary" >
                                        Show
                                    </button></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <!-- modal trigger button -->
                                    <a href="mail-invoice.php" target="_blank">
                                    <button type="button" class="btn btn-primary">
                                        Show
                                    </button></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="card-title">Pramotional</h5>
                                    <!-- modal trigger button -->
                                <a  href="mail-promotional.php" target="_blank">
                                    <button type="button" class="btn btn-primary">
                                        Show
                                    </button></a>
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-sm-5 mx-50 pb-4">
                                ...
                                <ul class="list-group list-group-flush mb-2">
                                    ...
                                    <li class="list-group-item d-flex align-items-start border-0 px-0">
                                        <div class="avatar me-75">
                                            <img src="app-assets/images/portrait/small/avatar-s-3.jpg" alt="avatar" width="38" height="38" />
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="me-1">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-flat-secondary dropdown-toggle" type="button" id="member2" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <li class="list-group-item d-flex align-items-start border-0 px-0">
                                        <div class="avatar me-75">
                                            <img src="app-assets/images/portrait/small/avatar-s-5.jpg" alt="avatar" width="38" height="38" />
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="me-1">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-flat-secondary dropdown-toggle" type="button" id="member3" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <li class="list-group-item d-flex align-items-start border-0 px-0">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-flat-secondary dropdown-toggle" type="button" id="member4" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <li class="list-group-item d-flex align-items-start border-0 px-0">
                                        <div class="avatar me-75">
                                            <img src="app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" width="38" height="38" />
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="me-1">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-flat-secondary dropdown-toggle" type="button" id="member5" data-bs-toggle="dropdown" aria-expanded="false">
                                                    <span class="d-none d-lg-inline-block">Can edit</span>
                                                </button>
                                    ...
                                    <li class="list-group-item d-flex align-items-start border-0 px-0">
                                        <div class="avatar me-75">
                                            <img src="app-assets/images/portrait/small/avatar-s-10.jpg" alt="avatar" width="38" height="38" />
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="me-1">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-flat-secondary dropdown-toggle" type="button" id="member6" data-bs-toggle="dropdown" aria-expanded="false">
                                                    <span class="d-none d-lg-inline-block">Can view</span>
                                                </button>
                                    ...
                                    <li class="list-group-item d-flex align-items-start border-0 px-0">
                                        <div class="avatar me-75">
                                            <img src="app-assets/images/portrait/small/avatar-s-8.jpg" alt="avatar" width="38" height="38" />
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="me-1">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-flat-secondary dropdown-toggle" type="button" id="member7" data-bs-toggle="dropdown" aria-expanded="false">
                                                    <span class="d-none d-lg-inline-block">Can comment</span>
                                                </button>
                                    ...
                                    <li class="list-group-item d-flex align-items-start border-0 px-0">
                                        <div class="avatar me-75">
                                            <img src="app-assets/images/portrait/small/avatar-s-6.jpg" alt="avatar" width="38" height="38" />
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between w-100">
                                            <div class="me-1">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn btn-flat-secondary dropdown-toggle" type="button" id="member8" data-bs-toggle="dropdown" aria-expanded="false">
                                                    <span class="d-none d-lg-inline-block">Can edit</span>
                                                </button>
                            ...
                            <div class="modal-body pb-3 px-sm-3">
                                ...
                                <div class="bs-stepper vertical wizard-modern create-app-wizard">
                                    ...
                                    <div class="bs-stepper-content shadow-none">
                                        ...
                                        <div id="create-app-frameworks" class="content" role="tabpanel" aria-labelledby="create-app-frameworks-trigger">
                                            <h5>Select Framework</h5>
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item border-0 px-0">
                                                    <label for="createAppReactNative" class="d-flex cursor-pointer">
                                                        <span class="avatar avatar-tag bg-light-info me-1">
                                                            <img src="app-assets/images/icons/technology/react.png" height="25" alt="react" />
                                                        </span>
                                                        <span class="d-flex align-items-center justify-content-between flex-grow-1">
                                                            <span class="me-1">
                                                ...
                                                <li class="list-group-item border-0 px-0">
                                                    <label for="createAppAngular" class="d-flex cursor-pointer">
                                                        <span class="avatar avatar-tag bg-light-danger me-1">
                                                            <img src="app-assets/images/icons/technology/angular.png" height="25" alt="angular" />
                                                        </span>
                                                        <span class="d-flex align-items-center justify-content-between flex-grow-1">
                                                            <span class="me-1">
                                                            ...
                                                            <span>
                                                                <input class="form-check-input" id="createAppAngular" type="radio" name="frameworkRadio" checked />
                                                            </span>
                                                        </span>
                                                    </label>
                                                </li>
                                                <li class="list-group-item border-0 px-0">
                                                    <label for="createAppVue" class="d-flex cursor-pointer">
                                                        <span class="avatar avatar-tag bg-light-success me-1">
                                                            <img src="app-assets/images/icons/technology/vue.png" height="25" alt="vue" />
                                                        </span>
                                                        <span class="d-flex align-items-center justify-content-between flex-grow-1">
                                                            <span class="me-1">
                                                ...
                                                <li class="list-group-item border-0 px-0">
                                                    <label for="createAppLaravel" class="d-flex cursor-pointer">
                                                        <span class="avatar avatar-tag bg-light-warning me-1">
                                                            <img src="app-assets/images/icons/technology/laravel.png" height="25" alt="laravel" />
                                                        </span>
                                                        <span class="d-flex align-items-center justify-content-between flex-grow-1">
                                                            <span class="me-1">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item border-0 px-0">
                                                    <label for="createAppFirebase" class="d-flex cursor-pointer">
                                                        <span class="avatar avatar-tag bg-light-danger me-1">
                                                            <img src="app-assets/images/icons/google.png" height="25" alt="google" />
                                                        </span>
                                                        <span class="d-flex align-items-center justify-content-between flex-grow-1">
                                                            <span class="me-1">
                                                ...
                                                <li class="list-group-item border-0 px-0">
                                                    <label for="createAppDynamoDB" class="d-flex cursor-pointer">
                                                        <span class="avatar avatar-tag bg-light-secondary me-1">
                                                            <img src="app-assets/images/icons/amazon.png" height="25" alt="amazon" />
                                                        </span>
                                                        <span class="d-flex align-items-center justify-content-between flex-grow-1">
                                                            <span class="me-1">
                                                            ...
                                                            <span>
                                                                <input class="form-check-input" id="createAppDynamoDB" type="radio" name="databaseRadio" checked />
                                                            </span>
                                                        </span>
                                                    </label>
                                                </li>
                                                <li class="list-group-item border-0 px-0">
                                                    <label for="createAppMysql" class="d-flex cursor-pointer">
                                                        <span class="avatar avatar-tag bg-light-info me-1">
                                                            <img src="app-assets/images/icons/database.png" height="25" alt="database" />
                                                        </span>
                                                        <span class="d-flex align-items-center justify-content-between flex-grow-1">
                                                            <span class="me-1">
