...
$(function () {
  ...
  if (productOption.length) {
    productOption.on("click", function () {
      ...
      $(this).children().children().attr("id", "selectImg");
      $(this).siblings().children().children().removeAttr("id");
      // img.siblings().removeClass('selectedImg');
      // $(this).addClass('selected').siblings().removeClass('selected');
      // let selectImg = $("#selectImg").prop("src");
      // $("#mainImg").attr("src", selectImg);

      let selectImg = $("#selectImg").html();
      // alert(selectImg);
      $("#mainImg").html(selectImg);
    });
  }
});