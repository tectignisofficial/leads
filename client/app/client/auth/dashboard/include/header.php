               ...
               <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link"
                       ...
                       <div class="user-nav d-sm-flex d-none"><span
                               class="user-name fw-bolder"><?php echo $_SESSION['aname']; ?></span><span
                               class="user-status">Client</span></div><span class="avatar">
                           <?php
                                                    if($_SESSION['image']==""){
                                         echo '<img src="app-assets/images/portrait/small/avatar-s-9.jpg" alt="Profile Picture" height="40" width="40"/>';
                                                    }else{  ?>
                           <img src="../../../../../admin/images/clientImage/<?php echo $_SESSION['image'] ?>"
                               alt="Profile Picture" height="40" width="40" />
                           <?php } ?>
                   ...
                   <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user"><a class="dropdown-item"
                           href="profile.php"><i class="me-50" data-feather="user"></i> Profile</a>
                       ...
                       <a class="dropdown-item" href="../../../../auth/path/logout.php"><i class="me-50"
