...
$res=mysqli_query($conn,"SELECT * FROM `email_config`");
...
if(isset($_POST['sub'])){
 ...
 try {
  ...
  $mail->SMTPAuth   = true;                           
  $mail->Username   = 'kspdvasg@gmail.com';           
  $mail->Password   = 'KSP@2022';                          
  $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;          
  $mail->Port       = 465;                            

  //Recipients
  $mail->setFrom('kspdvasg@gmail.com', 'Tectignis It Solution');
  ...
  $sql=mysqli_query($conn,"INSERT INTO `userlogin`(`username`, `email`, `password`) VALUES ('$name','$email_no','$passwordhash')");
    if($sql=1){
...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../../app/client/auth/dashboard/app-assets//images/ico/favicon.ico">
    ...
    <link rel="stylesheet" type="text/css" href="../../../app-asset/css/components.css">
...
<!-- 
                                ...
                                <form class="auth-register-form mt-2" method="POST">
                                    ...
                                    <button name="sub" class="btn btn-primary w-100" tabindex="5">Sign up</button>
                                </form>
    ...
    <!-- BEGIN: Vendor JS-->
    <script src="../../app/client/auth/dashboard/app-assets//vendors/js/vendors.min.js"></script>
    <!-- BEGIN Vendor JS-->

    <!-- BEGIN: Page Vendor JS-->
    <script src="../../app/client/auth/dashboard/app-assets//vendors/js/forms/validation/jquery.validate.min.js"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="../../app/client/auth/dashboard/app-assets//js/core/app-menu.js"></script>
    <script src="../../app/client/auth/dashboard/app-assets//js/core/app.js"></script>
    <!-- END: Theme JS-->

    <!-- BEGIN: Page JS-->
    <script src="../../app/client/auth/dashboard/app-assets//js/scripts/pages/auth-register.js"></script>
    <!-- END: Page JS-->
